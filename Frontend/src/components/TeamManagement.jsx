// TeamManagement component: renders a focused piece of the Kanvora UI.
import { useNavigate } from 'react-router-dom'
import { BsInbox, BsCalendar, BsLayoutWtf } from 'react-icons/bs'
import {
  featuresGrid,
  featureItemCard,
  featureItemIcon,
...
function TeamManagement() {
  ...
  const featuresData = [
    ...
    },
    {
      ...
      desc: 'Use this Kanvora project to store all the essential team resources including schedules, FAQs, project summaries, updates, and all of your yearly accomplishments.',
      onClick: () => {}
    }
  ]
  return (
    <div>
      ...
      >
        ...
        <p className="text-2xl text-center mt-4">
          ...
          practices and workflows with Kanvora.
        </p>
      </div>
      <div className="p-5 flex justify-center gap-7">
        ...
        <div>
          <p className="text-3xl ml-5">
            Kanvora's projects, lists, and cards enable <br /> teams to go from
            ideas to action in <br /> seconds. Visual and easy-to-use, Kanvora{' '}
            <br /> helps teams bring projects to life and <br /> keep them
            moving forward.
          </p>
          <button
            className={`${accentBg} p-5 rounded-2xl cursor-pointer border text-white ml-5 mt-12`}
      ...
      <div className={`${pageBg} py-30 mt-12 mb-7`}>
        <div className="-mt-25">
      ...
      <div className="grid grid-cols-2 m-10 gap-3">
        <div className="text-center border pb-5 m-0 hover:shadow-2xl transition-all duration-300 ">
          ...
          <h1 className={`text-2xl ${primaryText}`}>
            SwagUp:Scale Any business With Kanvora Bc
          </h1>
